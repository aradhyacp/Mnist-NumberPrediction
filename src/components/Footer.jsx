...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="flex justify-center text-black text-3xl font-raleway font-medium">
      Neural Network 
    </div>

    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      Number prediction through Neural Network using TensorFlowJS trained on mnist dataset.
    </p>
